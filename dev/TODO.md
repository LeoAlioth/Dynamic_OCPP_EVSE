...
107. - [x] Add HA integration tests to CI — both release workflows now run calculation scenario tests + pytest integration tests (config flow, sensor update, migration) before creating releases
