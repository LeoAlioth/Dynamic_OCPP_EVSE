...
class SiteContext:
    ...
    voltage: float = DEFAULT_PHASE_VOLTAGE
    main_breaker_rating: float = DEFAULT_MAIN_BREAKER_RATING
    ...
    battery_soc_hysteresis: float = DEFAULT_BATTERY_SOC_HYSTERESIS
    ...
    excess_export_threshold: float = DEFAULT_EXCESS_EXPORT_THRESHOLD
...
@dataclass
class ChargeContext:
    """DEPRECATED: Legacy context object. Use SiteContext + ChargerContext instead."""
    state: dict
    phases: int
    voltage: float
